...
Because Chai uses [zustand 🐻](https://github.com/pmndrs/zustand) under the hood, fine-grained reactivity has never been easier. `select` delegates to Zustand and only re-renders when the
