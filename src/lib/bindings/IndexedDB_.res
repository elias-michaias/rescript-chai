...
@get external objectStoreNames: database => array<string> = "objectStoreNames"
...
@get external length: array<string> => int = "length"
@send external item: (array<string>, int) => string = "item"
