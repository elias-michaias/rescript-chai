...
import * as Glue from "./glue/Glue.bs.js";
...
function track(useInstance) {
  var useTrackedInstance = function (init) {
    ...
    var useTracked = Glue.createTrackedSelectorFromUseStore(useStateFromStore);
    var state = useTracked();
    if (init !== undefined) {
      Glue.useEffect0(function () {
            dispatch(init());
          });
    }
    return [
...
function pour(useInstanceHook, opts) {
  return function (init) {
    ...
    var lastRawRef = Glue.useRef();
    var filteredRef = Glue.useRef();
    ...
    var useTracked = Glue.createTrackedSelector(useStateFromFiltered);
    var state = useTracked();
